describe "Linear Search" do
  it "ensure search element 20 is found" do
  ...
  it "ensure found 110 in array result index and element" do
  ...
  it "ensure search by element 175 is not present in array" do
    array = [10, 20, 80, 30, 60, 50, 110, 100, 130, 170]
    valueSearch = 175
    findIndex = -1
